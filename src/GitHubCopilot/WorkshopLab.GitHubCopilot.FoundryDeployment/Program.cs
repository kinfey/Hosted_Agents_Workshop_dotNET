...
string agentName = GetOptionalValue(arguments, "agent-name", null) ?? "github-copilot-readiness-coach";
...
Console.WriteLine("Next step: start the AppHost container and verify the AG-UI endpoint before connecting clients.");
